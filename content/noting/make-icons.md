...
发现了一个网站，[Icon Archive](https://www.iconarchive.com/) ，可以直接保存 .ico 和 .icns 图标，也可以保存其他不同大小的图片，十分方便。
...
安装 [Inkscape](https://inkscape.org/) ，安装 [ImageMagick](https://imagemagick.org/) 。
...
安装 [Inkscape](https://inkscape.org/) ，安装 [Image2Icon](https://img2icnsapp.com/) 。
...
[Image2Icon](https://img2icnsapp.com/how-to-create-the-best-mac-icons/) 建议使用 1024x1024 大小的图片创建 .icns 图标，因此我们先用 Inkscape 把 .svg 文件转成 1024x1024 大小的 .png 文件。在终端运行如下命令：
