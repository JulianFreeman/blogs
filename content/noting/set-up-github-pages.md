...
- 安装 jekyll（反正我是没打算尝试别的选择）。[这里](https://jekyllrb.com/docs/installation/ubuntu/) 是 Ubuntu 上的安装方法。

## 挑选模板

因为本人技术不精，折腾不出来好看的网站，所以只能找现成的了。[这里](https://jekyllthemes.io/free) 有一些免费的主题。
...
[这](https://docs.github.com/zh/pages/setting-up-a-github-pages-site-with-jekyll/testing-your-github-pages-site-locally-with-jekyll) 是官方教程网站。
